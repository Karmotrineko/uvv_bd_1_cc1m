...
GRANT ALL PRIVILEGES ON uvv.* TO 'rafael'@localhost;
...
CREATE TABLE regioes (
                id_regiao INT NOT NULL COMMENT 'Chave primária da tabela.',
                nome VARCHAR(25) NOT NULL COMMENT 'Contém os nomes das regiões.',
                PRIMARY KEY (id_regiao)
);

ALTER TABLE regioes COMMENT 'Tabela de regiões. Contém o numero determinado e o nome das regiões.';

-- Criando atributo de chave única
...
CREATE TABLE paises (
                id_pais CHAR(2) NOT NULL COMMENT 'Chave primária da tabela.',
                nome VARCHAR(50) NOT NULL COMMENT 'Contém o nome dos países.',
                id_regiao INT NOT NULL COMMENT 'Chave estrangeira tabela de regiões.',
                PRIMARY KEY (id_pais)
);

ALTER TABLE paises COMMENT 'Tabela de países, contém o país e a região da empresa.';
...
CREATE TABLE localizacoes (
                id_localizacao INT NOT NULL COMMENT 'Chave primária da tabela.',
                endereco VARCHAR(50) COMMENT 'Contém um endereço da empresa.',
                cep VARCHAR(12) COMMENT 'Contém um CEP da empresa.',
                cidade VARCHAR(50) COMMENT 'Contém uma cidade da empresa.',
                uf VARCHAR(25) COMMENT 'Contém um estado da empresa.',
                id_pais CHAR(2) NOT NULL COMMENT 'Chave estrangeira.',
                PRIMARY KEY (id_localizacao)
);

ALTER TABLE localizacoes COMMENT 'Tabela que contém as localizações da empresa.';

-- Criando a tabela departamentos

CREATE TABLE departamentos (
                id_departamento INT NOT NULL COMMENT 'Chave primária da tabela.',
                nome VARCHAR(50) COMMENT 'Contém o nome do departamento.',
                id_localizacao INT NOT NULL COMMENT 'Chave estrangeira.',
                id_gerente INT COMMENT 'Contém o nome do gerente',
                PRIMARY KEY (id_departamento)
);

ALTER TABLE departamentos COMMENT 'Tabela de departamentos.';
...
CREATE TABLE cargos (
                id_cargo VARCHAR(10) NOT NULL COMMENT 'Chave primária da tabela.',
                cargo VARCHAR(35) NOT NULL COMMENT 'Contém o nome de cada cargo.',
                salario_minimo DECIMAL(8,2) COMMENT 'Contém o menor salário de um cargo determinado.',
                salario_maximo DECIMAL(8,2) COMMENT 'Contém o maior salário de um cargo determinado.',
...
ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'Contém o nome completo do empregado.';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Primeira parte do email do empregado.';
...
ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave est para tabela cargos.';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Contém o salário atual do empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Porcetagem de comissão de um empregado.';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira para departamentos.';
...
-- Criando a tabela historicocargos
...
ALTER TABLE historicocargos COMMENT 'Tabela que contém o histórico de cargos de um empregado.';

ALTER TABLE historicocargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Chave primária composta.';

ALTER TABLE historicocargos MODIFY COLUMN data_inicial DATE COMMENT 'Chave primária composta.';

ALTER TABLE historicocargos MODIFY COLUMN data_final DATE COMMENT 'Contém o último dia de um empregado neste cargo.';

ALTER TABLE historicocargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira.';

ALTER TABLE historicocargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira.';

-- Criando atributo de chave estrangeira em paises
...
-- Criando atributo de chave estrangeira em localizacoes
...
-- Criando atributo de chave estrangeira em departamentos
...
-- Criando atributo de chave estrangeira em empregados
...
-- Criando atributo de chave estrangeira em historicocargos

ALTER TABLE historicocargos ADD CONSTRAINT departamentos_historico_cargos_fk
FOREIGN KEY (id_departamento)
REFERENCES departamentos (id_departamento)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE historicocargos ADD CONSTRAINT cargos_historico_cargos_fk
FOREIGN KEY (id_cargo)
REFERENCES cargos (id_cargo)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE historicocargos ADD CONSTRAINT empregados_historico_cargos_fk
...
-- Inserindo dados na tabela historicocargos:

insert into historicocargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES
